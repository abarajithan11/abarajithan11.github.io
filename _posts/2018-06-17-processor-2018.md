---
title: 'Custom Processor (Verilog), ISA, Compiler & Simulator (Python)'
date: 2018-06-17 18:36:00
last_modified_at: 2021-11-18 04:44:04
categories:
  - 'Projects'
tags:
  - 'Undergrad'
permalink: /processor-2018/
---

![]({{ site.content_base_url }}/images/2021/11/Processor-complete-borderless.png)

![]({{ site.content_base_url }}/images/2021/11/Processor-complete-borderless-1.png)
...
![]({{ site.content_base_url }}/images/2021/11/4_Program.png)

![]({{ site.content_base_url }}/images/2021/11/5_Simulate.png)
...
![]({{ site.content_base_url }}/images/2021/11/image-4.png)

![]({{ site.content_base_url }}/images/2021/11/bilinear_upsample.png)

![]({{ site.content_base_url }}/images/2021/11/custom_filter-1.png)

![]({{ site.content_base_url }}/images/2021/11/DIVdownsample.png)

![]({{ site.content_base_url }}/images/2021/11/downBy3.png)

![]({{ site.content_base_url }}/images/2021/11/downByANY.png)

![]({{ site.content_base_url }}/images/2021/11/EdgeDetectHorz.png)

![]({{ site.content_base_url }}/images/2021/11/EdgeDetectVert.png)

![]({{ site.content_base_url }}/images/2021/11/GaussianSmoothing.png)

![]({{ site.content_base_url }}/images/2021/11/PrimeFinder.png)

Algorithms I wrote in our assembly, first verified in my python-based simulator, then run on FPGA based implementation of the processor
...
![]({{ site.content_base_url }}/images/2021/11/image-5.png)

## Results

![]({{ site.content_base_url }}/images/2021/11/Bilinear_upsampple.png)

![]({{ site.content_base_url }}/images/2021/11/Downsampple_By_2_Snake_algorithm.png)

![]({{ site.content_base_url }}/images/2021/11/Custom_filter.png)

![]({{ site.content_base_url }}/images/2021/11/Edge_detection-waterfall.png)

![]({{ site.content_base_url }}/images/2021/11/Fibonacci_Series.png)

![]({{ site.content_base_url }}/images/2021/11/Pascal_Triangle.png)

Upsampling, Downsampling, Custom filtering, Edge Detection, Fibonacci, Pascal Triangle

## Report

<https://drive.google.com/file/d/1ObpKNKtklwhv3zmWbPKoYd_jBMk35f5c/preview>
